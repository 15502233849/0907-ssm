	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span24">
			<div class="step step1">
				...
				<table>
					...
					<tr>
						...
						<tr>
							...
							<td>
								<a href="${ pageContext.request.contextPath }/cart/CartServlet?m=removeCart&id=${item.product.id}" class="delete">删除</a>
							</td>
						</tr>
						</c:forEach>
					</tbody>
				...
				<div class="bottom">
					<a href="${ pageContext.request.contextPath }/cart/CartServlet?m=clearCart" id="clear" class="clear">清空购物车</a>
					<a href="${ pageContext.request.contextPath }/order/OrderServlet?m=saveOrder" id="submit" class="submit">提交订单</a>
				</div>
