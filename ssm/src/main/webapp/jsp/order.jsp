...
<div class="container cart">
		...
		<div class="span24">
			...
			<form id="orderForm" action="${ pageContext.request.contextPath }/order/OrderServlet?m=payOrder" method="post">
				<input type="hidden" name="id" value="${order.id}"/>
				<div class="span24">
					<p>
							收货地址：<input name="addr" type="text" value="${order.addr}" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${order.name}" style="width:150px" />
								<br /> 
							联系方式：<input name="phone" type="text"value="${order.phone}" style="width:150px" />
