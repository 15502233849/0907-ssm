		...
		<div class="span18 last">
			...
			<div class="info">
				<dl>
					<dt>商城价:</dt>
					<dd>
						<strong>￥：${product.shopPrice}元</strong>
							参 考 价：
			...
			<form id="cartForm" action="${ pageContext.request.contextPath }/cart/CartServlet?m=add" method="post" >
