			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
						...
						<ul class="tabContent" style="display: block;">
							<c:forEach items="${hotlist}" var="hot">
									<li>
										<a href="${ pageContext.request.contextPath }/ProductServlet?m=show&id=${hot.id}" target="_blank"><img src="${hot.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
									</li>
							</c:forEach>		
						</ul>
...
<!-- 					<div class="newProductAd">
						 ...
						 <ul class="tabContent" style="display: block;">
						 	<c:forEach items="${newslist}" var="n">
									<li>
										<a href="${ pageContext.request.contextPath }/ProductServlet?m=show&id=${n.id}" target="_blank"><img src="${n.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									</li>
									</li>
							</c:forEach>		
						</ul>
						<ul class="tabContent" style="display: none;">
