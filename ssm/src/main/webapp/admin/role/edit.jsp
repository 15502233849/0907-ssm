...
<HTML>
		  ...
		  $("#userAction_save_do").validate({
			  rules:{
				 name:{
					 required:true,
					 remote:{
						 url:"${pageContext.request.contextPath}/adminRole/validName.do",
						 type:"post",
						 data:{
							 name:function(){
								 return $("#name").val();
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminRole/update.do" method="post">
