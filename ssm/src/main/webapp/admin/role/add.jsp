...
<HTML>
	  ...
	  $(function(){
		  ...
		  $("#userAction_save_do").validate({
			  rules:{
				  name:{
					  required:true,
					  remote:"${pageContext.request.contextPath}/adminRole/validName.do"
				  }
			  },
			  messages:{
				  name:{
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminRole/add.do" method="post">
			&nbsp;
